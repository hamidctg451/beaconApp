              ...
              <div class="container">
                ...
                <div class="panel panel-defult">
                    <div class="panel-heading">
                        <h2>User Login <span class="pull-right"><strong> Now ON Partiars </strong> <? php date_default_timezone_set('Asia/Dhana'); echo ":" . date("Y:m:d h:i:s A");?></span></h2>
                    </div>    
                        ...
                        <form class="form" action="#" method="POST" enctype="multipart/form-date" autocomplete="off">
                            <div class="row">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <button> Login </button>
                                    <p>New Member Registration First <a href="login">Sing Up Here </a></p>
