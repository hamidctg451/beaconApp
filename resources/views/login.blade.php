              ...
              <div class="container">
                ...
                <div class="panel panel-defult">
                    <div class="panel-heading">
                        <h2>User Login <span class="pull-right"> <strong> Now </strong> 
                            <? php date_default_timezone_set('Asia/Dhana') echo ":" . date("Y:m:d h:i:s A")?>
                        </span></h2>
                    </div>    
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="name" class="form-control" id="name" name="name"  placeholder="Enter User Full name" required="Please Enter Your User Name" />
                                    </div>
                                    <div class="form-group">
